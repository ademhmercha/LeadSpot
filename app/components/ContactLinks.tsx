...
function buildMailtoHref(email: string, name?: string, address?: string | null): string {
  const subject = `Proposition de site web — ${name ?? ""}`;
  const body = [
    "Bonjour,",
    "",
    "Nous accompagnons les entreprises locales dans la création de leur site web.",
        ...
        <span className="inline-flex items-center gap-1.5">
          ...
          {whatsapp && (
            <a
              ...
              className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-gray-100 text-gray-600 transition-colors hover:bg-brand-100 hover:text-brand-700"
            >
              <svg viewBox="0 0 20 20" fill="currentColor" className="h-3.5 w-3.5 shrink-0">
                <path d="M3.654 1.328a.678.678 0 0 1 1.015-.063l2.223 2.222c.284.283.359.71.186 1.06l-1.15 2.3a1 1 0 0 0 .18 1.146l4.899 4.899a1 1 0 0 0 1.145.18l2.301-1.15a.678.678 0 0 1 1.06.187l2.222 2.222a.678.678 0 0 1-.063 1.015l-1.939 1.454a1.678 1.678 0 0 1-1.85.13C10.586 14.32 5.68 9.415 3.02 5.117a1.678 1.678 0 0 1 .13-1.85l1.454-1.939Z" />
              </svg>
