...
const STATUS_STYLES: Record<LeadStatus, string> = {
  ...
  interesse: "bg-purple-100 text-purple-800 dark:bg-purple-950 dark:text-purple-300",
  converti: "bg-green-100 text-green-800 dark:bg-green-950 dark:text-green-300",
  pas_interesse: "bg-gray-200 text-gray-600 dark:bg-gray-800 dark:text-gray-400",
};
